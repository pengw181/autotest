...
class TableBelong:
    ...
    def data_clear(self, table_cn_name, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@id='tableName']/following-sibling::span[1]/input[1]").send_keys(table_cn_name)
        ...
        if fuzzy_match:
            ...
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='tableNameCh']/*[contains(@class,'tableNameCh')]/*[text()='{}']".format(table_cn_name))
