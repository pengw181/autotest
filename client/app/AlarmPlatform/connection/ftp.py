...
class FTP:
    ...
    def data_clear(self, ftp_name, fuzzy_match=False):
        ...
        self.browser.find_element(
            By.XPATH, "//*[@id='ftpName']/following-sibling::span[1]/input[1]").send_keys(ftp_name)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='ftpName']/*[contains(@class,'ftpName')]/*[starts-with(text(),'{}')]".format(ftp_name))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='ftpName']/*[contains(@class,'ftpName')]/*[text()='{}']".format(ftp_name))
