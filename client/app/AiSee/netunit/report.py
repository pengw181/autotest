...
from client.page.func.tableData import get_table_data
...
class ConnectTestReport(object):
    ...
    def get_connect_result_detail(self, row_num=1):
        ...
        element = self.browser.find_element(
            By.XPATH, "//*[@menuid='AiSee_Netunit2013']/following-sibling::div[1]//*[@id='tb']/following-sibling::div[1]/div[2]/div[2]//table//tr[{}]/td[3]//a".format(
                row_num))
        element.click()
        # 切到登录明细页面
        wait = WebDriverWait(self.browser, 30)
