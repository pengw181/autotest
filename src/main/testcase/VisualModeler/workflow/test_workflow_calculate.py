...
class CommonNodeCalculate(unittest.TestCase):
                ...
                "操作配置": [
                    {
                        ...
                        "运算配置": {
                            ...
                            "配置": {
                                "表达式": [
                                    ["自定义值", ["a1,1,15,100", "a2,2,11,600", "b1,3,20,1000", "c1,4,19,150"]]
                                ],
                                "输出名称": {
                                    "类型": "输入",
                                    "变量名": "原始数据"
    ...
    def test_18_process_node_opt_conf(self):
        u"""操作配置，添加操作，聚合运算，计数"""
        action = {
            "操作": "NodeOptConf",
            "参数": {
    ...
    def test_19_process_node_opt_conf(self):
    ...
    def test_41_process_node_end_conf(self):
        u"""设置结束节点状态为正常"""
        action = {
            "操作": "SetEndNode",
            "参数": {
