...
class DatabaseManagement(unittest.TestCase):
    ...
    def test_11_database_table_add_col(self):
        u"""数据管理，pg数据库，数据表添加字段，列名(数据库)包含特殊字符"""
        action = {
            "操作": "AddDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_12_database_table_add_col(self):
        u"""数据管理，pg数据库，数据表添加字段，列名(数据库)包含中文"""
        action = {
            "操作": "AddDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_13_database_table_add_col(self):
        u"""数据管理，pg数据库，数据表添加字段，列名(数据库)以数字开头"""
        action = {
            "操作": "AddDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_14_database_table_add_col(self):
        u"""数据管理，pg数据库，数据表添加字段，列名(数据库)包含空格在中间"""
        action = {
            "操作": "AddDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_16_database_table_edit_col(self):
        u"""数据管理，pg数据库，数据表修改字段，修改长度，由长变短"""
        action = {
            "操作": "EditDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_17_database_table_edit_col(self):
        u"""数据管理，pg数据库，数据表修改字段，修改长度，由短变长"""
        action = {
            "操作": "EditDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_20_database_table_edit_col(self):
        u"""数据管理，pg数据库，数据表修改字段，修改日期格式，改成自定义"""
        action = {
            "操作": "EditDBTableCol",
            "参数": {
                "数据库名称": "auto_postgres数据库",
    ...
    def test_32_database_table_import(self):
        u"""数据管理，pg数据库，导入表，导入文件日期类型缺失字段格式"""
        action = {
            "操作": "ImportDBTable",
            "参数": {
                "数据库名称": "auto_postgres数据库",
