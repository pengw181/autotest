...
class VarEditor:
    ...
    def add(self, var_name, var_type, var_desc, algorithm_list, time_set, list_content, agg_func_set, func_set):
        ...
        elif self.var_mode == "业务变量":
            self._add_service_var(var_name=var_name)
        else:
    ...
    def _add_service_var(self, var_name):
        self.browser.find_element(By.XPATH, "//*[@data-menu='businessMode']//*[text()='{}']".format(var_name)).click()
        sleep(1)
...
def variable_manage(var_mode, var_name, var_type, var_desc, algorithm_list, time_set, list_content,
