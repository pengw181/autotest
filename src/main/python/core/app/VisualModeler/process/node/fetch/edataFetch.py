...
def edata_fetch(opt, target_var, var_name, obj_type, result_type, cmd_name, value_type):
    ...
    if opt == "添加":
        ...
        browser.switch_to.frame(
            browser.find_element(By.XPATH, "//iframe[contains(@src,'getdataEdataCustomNodeEdit.html?type=add')]"))
        wait = WebDriverWait(browser, 30)
        ...
        sleep(1)
        browser.switch_to.frame(
            browser.find_element(By.XPATH, "//iframe[contains(@src,'getdataEdataCustomNodeEdit.html?type=edit')]"))
