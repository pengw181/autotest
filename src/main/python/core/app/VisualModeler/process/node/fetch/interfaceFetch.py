...
def interface_fetch(opt, target_var, var_name, expression, value_type):
    ...
    if opt == "添加":
        ...
        if expression:
            ...
            browser.find_element(By.XPATH, "//*[@name='varExpr']/preceding-sibling::input").send_keys(expression)
        ...
        # 点击保存
        browser.find_element(By.XPATH, "//*[@onclick='addPortDataRow()']").click()
    ...
    # 切换到取数配置iframe
    browser.switch_to.frame(browser.find_element(By.XPATH, "//iframe[contains(@src,'getDataPortNode.html')]"))
