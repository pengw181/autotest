...
from src.main.python.core.app.AlarmPlatform.connection.database import DatabaseConfig
from src.main.python.core.app.AlarmPlatform.connection.tableBelong import TableBelong
from src.main.python.core.app.AlarmPlatform.connection.ftp import FTP
from src.main.python.core.app.AlarmPlatform.config.metadata import MetaData
from src.main.python.core.app.AlarmPlatform.config.dictionary import Dictionary
...
@Wrap(wrap_func='enter_platform', param="告警平台")
