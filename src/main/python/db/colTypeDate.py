...
def checkColTypeDate(table_name, schema, col):
    ...
    if table_name.upper() not in gbl.service.get("DataTableName"):
        if gbl.service.get("DatabaseType") == "oracle":
        ...
        elif gbl.service.get("DatabaseType") == "mysql":
        ...
        elif gbl.service.get("DatabaseType") == "postgres":
    ...
    col = str(col.upper())
    date_type = True if col in gbl.service.get("DataCol") else False
    return date_type
