...
class Script:
    ...
    def choose(self, script_name):
        ...
        self.browser.find_element(
            By.XPATH, "//*[contains(text(),'脚本类型')]/../following-sibling::div[1]//*[text()='查询']").click()
        page_wait()
        self.browser.find_element(
            By.XPATH, "//*[contains(@id,'scriptManage')]//*[text()='{0}']".format(script_name)).click()
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='scriptName']/preceding-sibling::input").clear()
        self.browser.find_element(By.XPATH, "//*[@name='scriptName']/preceding-sibling::input").send_keys(obj)
        self.browser.find_element(
            By.XPATH, "//*[contains(text(),'脚本类型')]/../following-sibling::div[1]//*[text()='查询']").click()
        page_wait()
        ...
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='scriptName']/*[contains(@class,'scriptName') and starts-with(text(),'{0}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='scriptName']/*[contains(@class,'scriptName') and text()='{0}']".format(obj))
