...
class Database:
    ...
    def choose(self, db_name):
        ...
        page_wait()
        self.browser.find_element(By.XPATH, "//*[contains(@id,'dbCfg_info_tab_')]//*[text()='{0}']".format(db_name)).click()
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='dbName']/preceding-sibling::input").clear()
        self.browser.find_element(By.XPATH, "//*[@name='dbName']/preceding-sibling::input").send_keys(obj)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='dbName']/*[contains(@class,'dbName') and starts-with(text(),'{0}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='dbName']/*[contains(@class,'dbName') and text()='{0}']".format(obj))
