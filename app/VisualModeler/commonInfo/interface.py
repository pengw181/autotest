...
class Interface:
    ...
    def choose(self, interface_name):
        ...
        page_wait()
        self.browser.find_element(By.XPATH, "//*[@field='interfaceName']//*[@data-mtips='{0}']".format(interface_name)).click()
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='interfaceName']/preceding-sibling::input").clear()
        self.browser.find_element(By.XPATH, "//*[@name='interfaceName']/preceding-sibling::input").send_keys(obj)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='interfaceName']//*[starts-with(@data-mtips,'{}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='interfaceName']//*[@data-mtips='{}']".format(obj))
