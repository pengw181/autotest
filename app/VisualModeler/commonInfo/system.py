...
class ThirdSystem:
    ...
    def choose(self, platform_name):
        ...
        """
        self.browser.find_element(By.XPATH, "//*[@name='platform']/preceding-sibling::input").send_keys(platform_name)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        self.browser.find_element(
            By.XPATH, "//*[contains(@id,'nodeVosLogin_info_tab_')]//*[text()='{0}']".format(platform_name)).click()
    ...
    def test(self, obj, code=None):
        ...
        if exist:
            ...
            if alert.title_contains("测试成功"):
                ...
                log.warning("{0} 测试失败，测试返回结果: {1}".format(obj, msg))
            set_global_var("ResultMsg", msg, False)
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='platform']/preceding-sibling::input").clear()
        self.browser.find_element(By.XPATH, "//*[@name='platform']/preceding-sibling::input").send_keys(obj)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='platform']/*[contains(@class,'platform')]/*[starts-with(text(),'{0}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='platform']/*[contains(@class,'platform')]/*[text()='{0}']".format(obj))
