...
class Mail:
    ...
    def choose(self, mail_addr):
        ...
        page_wait()
        self.browser.find_element(By.XPATH, "//*[contains(@id,'emailCfg')]//*[text()='{0}']".format(mail_addr)).click()
    ...
    def update(self, obj, mail_addr, mail_type, data_type, send_protocol, send_server, send_port, receive_protocol,
        ...
        if exist:
            ...
            if alert.title_contains("成功"):
                ...
                log.warning("{0} 修改失败，失败提示: {1}".format(mail_addr, msg))
            set_global_var("ResultMsg", msg, False)
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='mailAddr']/preceding-sibling::input").clear()
        self.browser.find_element(By.XPATH, "//*[@name='mailAddr']/preceding-sibling::input").send_keys(obj)
        self.browser.find_element(By.XPATH, "//*[@id='btn']//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='mailAddr']/*[contains(@class,'mailAddr') and starts-with(text(),'{0}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='mailAddr']/*[contains(@class,'mailAddr') and text()='{0}']".format(obj))
