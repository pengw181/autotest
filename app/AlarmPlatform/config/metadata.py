...
class MetaData:
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@id='metadataName']/following-sibling::span[1]/input[1]").send_keys(obj)
        ...
        if fuzzy_match:
            ...
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='metadataName']/*[contains(@class,'metadataName')]/*[text()='{}']".format(obj))
