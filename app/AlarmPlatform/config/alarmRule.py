...
class AlarmRule:
    ...
    def update_status(self, obj, set_status, research=True):
        ...
        if set_status == "启用":
            if current_status:
                ...
                self.browser.find_element(
                    By.XPATH, "//*[text()='{0}']/../../../following-sibling::td[2]/div/span".format(obj)).click()
    ...
    def data_clear(self, obj, fuzzy_match=False):
        ...
        self.browser.find_element(By.XPATH, "//*[@name='alarmRuleName']/preceding-sibling::input[1]").send_keys(obj)
        self.browser.find_element(By.XPATH, "//*[text()='查询']").click()
        page_wait()
        fuzzy_match = True if fuzzy_match == "是" else False
        if fuzzy_match:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='alarmRuleName']/div/span[@class='tree-title']/a[starts-with(text(),'{0}')]".format(obj))
        else:
            record_element = self.browser.find_elements(
                By.XPATH, "//*[@field='alarmRuleName']/div/span[@class='tree-title']/a[text()='{0}']".format(obj))
