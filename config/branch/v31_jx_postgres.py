...
def serviceInit():
    ...
    # 登录信息
    set_global_var("PageUrl", "http://192.168.88.206/AiSee/html/login/login.html")
    set_global_var("SystemLoginUrl", "https://192.168.88.116:9109/statics/html/login.html#")
    set_global_var("BelongID", "900100")
    set_global_var("DomainID", "AiSeeManager")
    set_global_var("LoginUser", "pw")
    set_global_var("LoginPwd", "1qazXSW@")
    set_global_var("Belong", "衡昊数据")
    set_global_var("Domain", "系统管理")

    # 第三方系统测试系统ip
    set_global_var("ThirdSystem", "http://192.168.88.206")
    ...
    set_global_var("DefaultDBName", "AiSee-衡昊数据", "service")
