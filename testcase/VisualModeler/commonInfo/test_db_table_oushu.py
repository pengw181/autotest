...
class DatabaseManagementOuShu(unittest.TestCase):
	...
	def test_4_AddDBTable(self):
		...
		CheckMsg|数据表名称不允许为空
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，数据表名称为空 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_5_AddDBTable(self):
		...
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，表英文名为空 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_6_AddDBTable(self):
		...
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，数据表名称在列表已添加过 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_7_AddDBTable(self):
		...
		CheckMsg|表中文名或英文名已存在
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，表英文名在列表已添加过 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_8_AddDBTable(self):
		...
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，数据表名称输入字符校验 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_9_AddDBTable(self):
		...
		"""
		log.info('>>>>> 数据管理，oushu数据库，添加表，表英文名输入字符校验 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_11_AddDBTableCol(self):
		...
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，列名(数据库)包含特殊字符 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_12_AddDBTableCol(self):
		...
		CheckMsg|列名(数据库)只能包含字母、数字、下划线，且不能以数字开头
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，列名(数据库)包含中文 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_13_AddDBTableCol(self):
		...
		CheckMsg|列名(数据库)只能包含字母、数字、下划线，且不能以数字开头
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，列名(数据库)以数字开头 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_14_AddDBTableCol(self):
		...
		CheckMsg|列名(数据库)只能包含字母、数字、下划线，且不能以数字开头
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，列名(数据库)包含空格在中间 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_15_EditDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，修改列名(自定义) <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_16_EditDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，修改长度，由长变短 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_17_EditDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，修改长度，由短变长 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_18_EditDBTableCol(self):
		u"""数据管理，oushu数据库，数据表修改字段，还原列名(自定义)"""
		action = {
			"操作": "EditDBTableCol",
			"参数": {
				"数据库名称": "auto_oushu数据库",
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，还原列名(自定义) <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_19_EditDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，修改日期格式 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_20_EditDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表修改字段，修改日期格式，改成自定义 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_21_AddDBTableCol(self):
		...
		CheckMsg|列名已存在
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，字段中文名已存在 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_22_AddDBTableCol(self):
		...
		CheckMsg|列名已存在
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表添加字段，字段英文名已存在 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_23_DeleteDBTableCol(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表删除字段 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_24_AddDBTableCol(self):
		...
		CheckMsg|保存成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，数据表已删除字段重新添加 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_25_ImportDBTable(self):
		...
		CheckMsg|表字段文件不能为空
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件为空 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_26_ImportDBTable(self):
		...
		CheckMsg|表字段文件不能为空
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件只有第一行表头 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_27_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件字段名称缺失 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_28_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件字段英文名缺失 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_29_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件字段类型缺失 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_30_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件字符类型缺失长度 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_31_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件数值类型缺失长度 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_32_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件日期类型缺失字段格式 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_33_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入文件含重复字段 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_35_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表1 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_36_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表2 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_37_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表3 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_38_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表4 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_39_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表5 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_40_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表6 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_41_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_导入表7 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_42_DeleteDBTable(self):
		...
		CheckMsg|删除成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，删除表：auto_测试表 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_46_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入超多字段，100列 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
	...
	def test_47_ImportDBTable(self):
		...
		CheckMsg|操作成功
		"""
		log.info('>>>>> 数据管理，oushu数据库，导入表，导入超多字段，200列 <<<<<')
		gbl.temp.set("StartTime", datetime.now().strftime('%Y%m%d%H%M%S'))
		result = self.worker.action(action)
		assert result
		log.info(gbl.temp.get("ResultMsg"))
