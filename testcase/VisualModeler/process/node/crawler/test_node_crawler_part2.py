...
class CrawlerNodePart2(unittest.TestCase):
    ...
    log.info("装载流程可视化操作模拟节点配置测试用例（2）")
    worker = CaseWorker()
    ...
    def test_54_process_node_business_conf(self):
        u"""配置可视化操作模拟节点，添加动作，form表单取数，配置期待值"""
        action = {
            "操作": "NodeBusinessConf",
            "参数": {
                "流程名称": "auto_可视化操作模拟节点流程",
    ...
    def test_55_process_node_business_conf(self):
        u"""配置可视化操作模拟节点，添加动作，form表单取数，不配置期待值"""
        action = {
            "操作": "NodeBusinessConf",
            "参数": {
                "流程名称": "auto_可视化操作模拟节点流程",
    ...
    def test_57_process_node_business_conf(self):
    ...
    def test_71_process_node_business_conf(self):
